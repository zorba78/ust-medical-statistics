...
This can easily be calculated in R by using the function mean(). We first extract the column we are interested in using the notation: DataSet$ColumnName 
...
In our simple case of five observations,  we first sort the data into  and then the middle observation is clearly 4. 
