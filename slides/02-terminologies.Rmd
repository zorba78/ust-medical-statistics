...
We'll learn about probability and probability distribution next week, but this time we'll go over the concept of terminology.

In statistics, population refers to the entire set of subjects of interest. 

For example, if the purpose of our study is to investigate the prevalence of dementia among the elderly in Korea, 
the population of 65 years or older residing in Korea is the total population of our study.


The sample is a subset of the population, and if we actually surveyed 500 elderly people in the study we designed, these 500 are the sample.

The act of collecting or extracting sample is called sampling. How do we collect samples in order for the sample we want to study to represent the population?

Suppose this circle represents the whole population of people older than 65 years. 


Let's say that this circle represents the population 65 years or older in South Korea. 
If we surveyed only the people in the circle below the center as subjects, would the sample we get represent the population?

Probably not. A sample that can be a relatively accurate representation of the population should be throughout the circle.

That is, only samples obtained randomly and evenly, regardless of the top and bottom of the circle, will be fully representative of the population. 

This sampling method is called random sampling. 
...
In fact, the highlight of statistics is sampling. We won't be covering anything related to sampling. 

However, if I mention the word sampling in this lecture, understand that it is random sampling.
