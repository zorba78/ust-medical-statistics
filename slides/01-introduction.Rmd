...
# Important Things in Statistics `r icon::fontawesome("exclamation-circle", style = "solid")`

---

# `r icon::fontawesome("table", style = "solid")` Data 
...
# `r icon::fontawesome("border-all", style = "solid")` Summarization, `r icon::fontawesome("chart-pie", style = "solid")` Visualization 
...
.right[
## `r icon::fontawesome("arrow-right", style = "solid")` So What???
...
# `r icon::fontawesome("lightbulb", style = "solid")` Inference 

## Two important terminologies in statistics
...
`r icon::fontawesome("arrow-right", style = "solid")` If we have a proper sample that represents the whole population, you can get NEARLY the correct answer
...
# Parameters `r icon::fontawesome("bible", style = "solid")`
...
# Estimation & Hypothesis Testing `r icon::fontawesome("cloud", style = "solid")`
