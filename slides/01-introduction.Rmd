...
a basic grasp of statistical literacy is more important than ever. 
...
In previous, numerous quotes about statistics are negatively expressed. 

Why did people express the way about statistics?
...
This is because statistics simply give numbers, but people attach certain meanings to these numbers. 
In other words, these quotes mean that you should pay special attention to interpretation and 
communication, because numbers do not advocate for themselves, and their meanings are completely 
different depending on your point of view.


Perhaps the reaction of most people who know a little about statistics and hear the word statistics 
is similar to the cat on the slide.

However, given the correct data, if you have the literacy to interpret statistics accurately and 
correctly, the various statistics provided by statistics have a strong power to understand t
he phenomenon and make the right decisions.
...
.pull-left[
<img src="https://www.highwelleducation.com/wp-content/uploads/2020/10/NINTCHDBPICT000001294259.jpg" align="center" width="75%" />
]
...
The following slide shows that a general understanding of a specific event is possible only with 
simple graphs without sophisticated statistical analysis.


This example comes from the book "Art of Statistics", written by David Spiegelhalter, who is a 
